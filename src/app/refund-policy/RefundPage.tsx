...
import { refundSections } from "@/lib/refund";
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        >
          <motion.div className="text-center mb-16" variants={sectionVariants}>
            ...
            >
              {`Fair, transparent, and writer-friendly. Your satisfaction is our priority.`}
            </p>
          </motion.div>
          ...
          >
            ...
            >
              {`Our support team is here to help with any refund requests or questions. We're committed to finding a fair solution that works for everyone.`}
            </p>
